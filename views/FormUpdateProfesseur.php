...
<form method="POST" action="<?= getUrlFor('Professeurs/edit/' . $prof->id) ?>" onsubmit="return validation()">
  <div class="form-group my-3">
    ...
    <input type="text" value="<?= $prof->Matricule ?? $_POST['Matricule'] ?? '' ?>" name="Matricule"
      class="form-control" id="Matricule" aria-describedby="textHelp">
  </div>
  <div class="form-group my-3">
    <label for="Nom_complet">Nom Complet</label>
    <input type="text" value="<?= $prof->Nom_complet ?? $_POST['Nom_complet'] ?? '' ?>" name="Nom_complet"
      class="form-control" id="Nom_complet" aria-describedby="textHelp">
  </div>
  <div class="form-group my-3">
