...
class StudentController{
    ...
    public function SaveStudent(){
        if(!empty($_POST['matricule']) || !empty($_POST['name'])||!empty($_POST['gender'])||!empty($_POST['id_class'])||!empty($_POST['id_parents'])||!empty($_POST['adresse'])||!empty($_POST['birthday'])||!empty($_POST['email'])||!empty($_POST['parent_name'])){
            $s1 = new Student();
